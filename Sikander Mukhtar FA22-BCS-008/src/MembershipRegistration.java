...
public class MembershipRegistration {
    ...
    // Using ArrayList instead of array , it is easy to remove and add a variable from ArrayList and I was having tons of errors while working with arrays. So I came to this conclusion.
    static ArrayList<Volunteer> volunteers = new ArrayList<>();

    //Static Method to get input in Volunteer
    public static ArrayList<Volunteer> getVolunteer(int maxVolunteers) {
        ...
        while (numVolunteers < maxVolunteers) {
            ...
            System.out.println("CUISkillBANK MEMBERSHIP REGISTRATION FORM");
            System.out.println("Membership Number : "+numVolunteers+1);
            System.out.println("Registration Date: "+java.time.LocalDate.now());

            System.out.println("\nSection-I Personal detail (You must fill this section using command line interface)\n");
    ...
    // I made this mehtod to test my array data whether its being stored correctly or not .
    //It has nothing to do in any class
